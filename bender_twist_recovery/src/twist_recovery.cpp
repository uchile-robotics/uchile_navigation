...
#include <bender_twist_recovery/twist_recovery.h>
#include <pluginlib/class_list_macros.h>
#include <tf/transform_datatypes.h>

// register as a RecoveryBehavior plugin
PLUGINLIB_DECLARE_CLASS(bender_twist_recovery, TwistRecovery, bender_twist_recovery::TwistRecovery, nav_core::RecoveryBehavior)

namespace bender_twist_recovery
{
