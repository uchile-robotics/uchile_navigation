...
#include "bender_nav/GoalServerState.h"
#include "bender_nav/GoalServer.h"
#include <bender_utils/ParameterServerWrapper.h>

using namespace bender_nav;

/* * * * * * * *
 * INIT STATE  *
 * * * * * * * */

InitState::InitState(bender_nav::GoalServer* goalServer): server(goalServer) {
 ...
 * * * * * * * */
 ...
 QuietState::QuietState(
			bender_nav::GoalServer* goalServer,
