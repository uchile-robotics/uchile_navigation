...
class CmdVelSafety(object):
    """Basic Bender safety"""
    def __init__(self):
        self.laser_front_param = rospy.get_param("bender_sensors_rgbd_head_link",
        ...
        self.scan_cb_rate = rospy.Rate(10)
        self.cnt_front = 0
        self.cnt_rear = 0
        ...
        try:
            while not rospy.is_shutdown():
                trans_front = self.scan_closest_point[0]
                rot_front = self.scan_closest_point[1]
